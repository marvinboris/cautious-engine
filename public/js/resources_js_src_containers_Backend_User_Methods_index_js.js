"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Methods_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Methods/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Methods/index.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_methods__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../store/actions/backend/methods */ "./resources/js/src/store/actions/backend/methods.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.methods,
      ...
      var redirect = !feature && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_14__.Redirect, {
        to: "/user/dashboard"
      });
      ...
      if (!methods) methods = [];
      var data = methods.map(function (method) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(method, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.convertDate)(method.created_at),
          action: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_15__.Link, {
              to: "/user/methods/".concat(method.id),
              className: "mx-1",
            ...
            }), JSON.parse(feature.permissions).includes('u') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_15__.Link, {
              to: "/user/methods/".concat(method.id, "/edit"),
              className: "mx-1",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
            ...
            }), JSON.parse(feature.permissions).includes('d') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)("span", {
              className: "mx-1",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_components_Backend_UI_Delete_Delete__WEBPACK_IMPORTED_MODULE_10__["default"], {
                deleteAction: function deleteAction() {
                  return _this.props["delete"](method.id);
                },
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
      ...
      var content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.Fragment, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__["default"], {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(_components_Backend_UI_List_List__WEBPACK_IMPORTED_MODULE_6__["default"], {
            ...
            bordered: true,
            add: add,
            link: "/user/methods/add",
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_16__.faThList,
            title: index,
            className: "shadow-sm",
            fields: [{
              name: form.name,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_methods__WEBPACK_IMPORTED_MODULE_11__.getMethods)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_methods__WEBPACK_IMPORTED_MODULE_11__.deleteMethods)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_methods__WEBPACK_IMPORTED_MODULE_11__.resetMethods)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/methods.js":
/*!***********************************************************!*\
  !*** ./resources/js/src/store/actions/backend/methods.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "resetMethods": () => (/* binding */ resetMethods),
/* harmony export */   "getMethods": () => (/* binding */ getMethods),
/* harmony export */   "getMethod": () => (/* binding */ getMethod),
/* harmony export */   "postMethods": () => (/* binding */ postMethods),
/* harmony export */   "patchMethods": () => (/* binding */ patchMethods),
/* harmony export */   "deleteMethods": () => (/* binding */ deleteMethods)
/* harmony export */ });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
...
var prefix = '/api/';
var resetMethods = function resetMethods() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.METHODS_RESET
  };
};

var methodsStart = function methodsStart() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.METHODS_START
  };
};

var methodsSuccess = function methodsSuccess(data) {
  return _objectSpread({
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.METHODS_SUCCESS
  }, data);
};

var methodsFail = function methodsFail(error) {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.METHODS_FAIL,
    error: error
  };
};
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              token = localStorage.getItem('token');
              _context.next = 6;
              return fetch("".concat(prefix + role, "/methods?page=").concat(page, "&show=").concat(show, "&search=").concat(search), {
                headers: {
                  Authorization: token
                }
              });
            ...
            case 13:
              ...
              console.log(_context.t0);
              dispatch(methodsFail(_context.t0));
...
var getMethod = function getMethod(id) {
  return /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              token = localStorage.getItem('token');
              _context2.next = 6;
              return fetch("".concat(prefix + role, "/methods/").concat(id), {
                headers: {
                  Authorization: token
                }
              });
            ...
            case 13:
              ...
              dispatch(methodsFail(_context2.t0));
...
var postMethods = function postMethods(data) {
  return /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return fetch("".concat(prefix + role, "/methods"), {
                method: 'POST',
                body: form,
                headers: {
                  Authorization: token
            ...
            case 20:
              ...
              dispatch(methodsFail(_context3.t0));
...
var patchMethods = function patchMethods(id, data) {
  return /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 16:
              ...
              dispatch(methodsFail(_context4.t0));
...
var deleteMethods = function deleteMethods(id) {
  return /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              token = localStorage.getItem('token');
              _context5.next = 9;
              return fetch("".concat(prefix + role, "/methods/").concat(id, "?page=").concat(page, "&show=").concat(show, "&search=").concat(search), {
                method: 'DELETE',
                headers: {
                  Authorization: token
                }
            ...
            case 18:
              ...
              dispatch(methodsFail(_context5.t0));
