    ...
    Route::middleware('auth:api')->group(function () {
        ...
        Route::middleware('permission')->group(function () {
            ...
            Route::prefix('enrolments')->name('enrolments.')->group(function () {
                Route::get('info', 'EnrolmentController@info')->name('info');
                Route::get('{form}', 'EnrolmentController@show')->name('show');
            });

            Route::prefix('payments')->name('payments.')->group(function () {
                Route::get('info', 'PaymentController@info')->name('info');
                Route::get('{form}', 'PaymentController@show')->name('show');
            });

            Route::prefix('courses')->name('courses.')->group(function () {
                Route::get('info', 'CourseController@info')->name('info');
                Route::get('{form}', 'CourseController@show')->name('show');
            });
