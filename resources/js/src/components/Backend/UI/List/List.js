    ...
    render() {
        ...
        return (
            <Col xs={xs} sm={sm} md={md} lg={lg} xl={xl} className={outerClassName}>
                ...
                <div className={`rounded-4 d-flex align-items-center mb-4 mb-sm-5 py-3 py-sm-4 px-4 px-sm-5 bg-${dark ? "greenblue" : "greenblue-10"}`}>
                ...
                <div className="row justify-content-center">
                    <div className={`${!addon && "col-lg-9"} ${containerClassName}`}>
                        <div className={`d-flex flex-column h-100 ${dark ? "bg-greenblue text-light " : " "}${className}`} style={style}>
                            <div className={`px-4 pt-4 text-700 position-relative`}>
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="ml-auto d-none d-md-flex align-items-center">
                                        ...
                                        <Input type="search" name="search" onChange={this.inputChangedHandler} className={`bg-${dark ? "darkblue" : "blue-10 text-secondary"} border-0 rounded-4`} style={{ maxWidth: 150 }} placeholder={`${search_}...`} />
                                    </div>
                                </div>
                            </div>
