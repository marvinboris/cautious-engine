    ...
    switch (role) {
        case 'user':
            ...
            sideDrawerItems = <>
                ...
                {sideDrawerItem(false, enrolments.title, null, "user-friends", "/user/enrolments")}
                {sideDrawerItem(false, payments.title, null, "usd-square", "/user/payments")}
                {sideDrawerItem(false, courses.title, null, "books", "/user/courses")}
        ...
        case 'admin':
            sideDrawerItems = <>
                ...
                {sideDrawerItem(true, enrolments.title, null, "user-friends", "/admin/enrolments")}
                {sideDrawerItem(true, payments.title, null, "usd-square", "/admin/payments")}
                {sideDrawerItem(true, courses.title, null, "books", "/admin/courses")}
