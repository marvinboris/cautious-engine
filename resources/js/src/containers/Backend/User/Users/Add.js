...
class Add extends Component {
    ...
    render() {
                            ...
                            <Row className="my-2 my-sm-3">
                                <div className="col-lg-9">
                                    <Row>
                                        ...
                                        <FormInput type="password" className="col-md-6" icon="lock" onChange={this.inputChangeHandler} value={password} name="password" placeholder={form.password} />
        ...
        return (
            <>
                <TitleWrapper>
                    <Breadcrumb items={this.props.edit && [{ to: '/user/users', content: index }]} main={this.props.edit ? edit : add} icon={icon} />
