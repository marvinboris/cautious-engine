...
class Add extends Component {
    ...
    render() {
                            ...
                            <Row className="my-2 my-sm-3">
                                <div className="col-lg-9">
                                    <Row>
                                        ...
                                        <FormInput type="text" className="col-md-6" icon={icon} onChange={this.inputChangeHandler} value={abbr} name="abbr" required placeholder={form.abbr} />
        ...
        return (
            <>
                <TitleWrapper>
                    <Breadcrumb items={this.props.edit && [{ to: '/user/languages', content: index }]} main={this.props.edit ? edit : add} icon={icon} />
