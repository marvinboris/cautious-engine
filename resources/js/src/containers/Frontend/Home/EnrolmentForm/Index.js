            ...
            <div className="col-xxl-8 col-md-10">
                ...
                <div className={"row" + (selectedPage === keys[0] ? "" : " d-none")}>
                    ...
                    <FormGroup className="col-md-6">
                        <input type="file" id="cv" name="cv" className="d-none" onChange={this.inputChangeHandler} accept=".pdf" />
                ...
                <div className={"row" + (selectedPage === keys[1] ? "" : " d-none")}>
                    ...
                    {Object.keys(sections[keys[1]].fields.subjects).map(key => {
                        ...
                        return <div key={key + Math.random()} className="col-12 mb-2 mb-md-3 mb-xxl-4 rounded-6 bg-white p-2 p-md-3 p-xxl-4">
                            <div className="px-md-1 px-xxl-2 d-flex align-items-center justify-content-between">
                                <div className="text-10 text-md-12 text-xxl-14">
                                    {sections[keys[1]].fields.english_level} <strong>{subject.name}</strong>
                                </div>

                                <div className="d-flex align-items-center">
                                    <div className={"text-" + subject.color}>
                                        <input type="hidden" name={key} />
                                        <Stars target={key} color={subject.color} />
                                    </div>

                                    <div className="pl-3 pl-md-4 pl-xxl-5">
                                        <div className={"ml-1 ml-md-2 ml-xxl-3 py-1 px-2 rounded-4 text-700 text-center mark-" + key + " text-" + subject.color + " bg-" + subject.color + "-25"} style={{ width: 40 }}>0</div>
                                    </div>
                                </div>
                            </div>
                        </div>
