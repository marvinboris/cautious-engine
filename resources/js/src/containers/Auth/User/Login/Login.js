...
export class Login extends Component {
    ...
    render() {
        ...
        titleContent = <>
            {login.dont_be_late}! <span className="text-greenblue">{login.get_in}</span>
        </>;
        ...
        formContent = <>
            ...
            <BetweenButton color="greenblue" size="lg" className="py-3 px-4 btn-block" icon={faSignInAlt}>{login.sign_in}</BetweenButton>
        </>;
